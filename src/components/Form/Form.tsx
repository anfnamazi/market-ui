import { Box, Button, Container, Grid, Stack, Text, Textarea, TextInput } from '@mantine/core';
  ...
  return (
    <Container size="xl">
      <Stack gap={16}>
        ...
        <Text>
          برای ارتقای بیزینس خود به دنبال فرصتی ناب هستید؟ فرم زیر را تکمیل کنید تا مشاوران ما به
          صورت کاملان رایگان شمارا راهنمایی کنند.
        </Text>
        <Box
          bg="white"
          p={40}
